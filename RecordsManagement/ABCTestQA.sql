...
DECLARE cQuestions CURSOR FOR 
       SELECT qt.QuizTakerName, qqg.groupName, qq.QuestionText, qtq.PresortedAnswerIds, qtq.QuizQuestionId FROM QuizTaker qt
       ...
       WHERE IsPaperTest = 1
       ORDER BY qt.QuizTakerName, qtq.SortOrder
