...
WITH    CTESys
    ...
    FROM    dbo.f_equipment e
            JOIN [tempdb].[dbo].[MULTILIN_UPDATE] u ON u.[TagNum] = e.fm_tagNumber;
...
--SELECT * FROM [tempdb].[dbo].[ExpansionUpdate] ORDER BY [description]

--SELECT * FROM f_equipment e WHERE e.fm_tagNumber = '009089'

--SELECT * FROM f_area a WHERE a.fu_pk = 456081
